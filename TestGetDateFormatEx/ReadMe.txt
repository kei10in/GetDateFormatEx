========================================================================
    コンソール アプリケーション: TestGetDateFormatEx プロジェクトの概要
========================================================================

この TestGetDateFormatEx アプリケーションは、AppWizard により作成されました。

このファイルには、TestGetDateFormatEx 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


TestGetDateFormatEx.vcxproj
...
TestGetDateFormatEx.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、TestGetDateFormatEx.pch 
